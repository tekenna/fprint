...
function Result1({res,books, trans, diet, mP, sD, alc, lt, text, clt}) {
    ...
    var total = Res + Trans + Diet + sD * 0.545 + alc * 0.378 + lt * 2.5 + clt *0.2756 *6.5 / 105 + books * 0.048 + text * 0.097
