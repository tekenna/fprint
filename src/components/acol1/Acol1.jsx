    ...
    return (
        <div className="acol1">
            <div className="acol1_sect">
                ...
                <p className="sect_p">To calculate carbon footprint, a lot of factors are to be taken into consideration. These factors ranges between the existing realtionships between the observable qauntity and it's environment.This calculator is to designed calculate carbon footprint of several qauntities with the Federal University of Technology Owerri as case study.</p>
            </div>
            <div className="acol1_sect">
                <span className="acol1_title">
                    <h3>CATEGORIES</h3>
